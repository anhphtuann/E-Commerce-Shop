...
namespace E_Commerce_Shop.Migrations
{
    ...
    [Migration("20230425082415_tableup12")]
    partial class tableup12
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Commerce_Shop.Models.Products", b =>
                {
                    ...
                    b.Property<int?>("CategoryForeignId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Commerce_Shop.Models.Products", b =>
                {
                    b.HasOne("E_Commerce_Shop.Models.Category", "CategoryForeign")
                        .WithMany("Product")
                        .HasForeignKey("CategoryForeignId");

                    b.Navigation("CategoryForeign");
                });
